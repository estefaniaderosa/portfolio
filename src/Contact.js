...
function Contact() {
    ...
    return (
        ...
        <div className="contact-container">
            ...
            <div className="contact"><a href={'./cvt_estefaniaderosagil.pdf'}><img src={`${process.env.PUBLIC_URL}/images/cv.png`} alt="resume icon" className="icon"/><p>{language === "spanish" ? "CV" : "Resume"}</p></a></div>
