...
function Skills() {
    return (
        ...
        <div className="skill-container">
            ...
            <div className="skill"><img src={`${process.env.PUBLIC_URL}/images/tailwind.png`} alt="Tailwind Logo" className="logo"/><p>Tailwind CSS</p></div>
            ...
            <div className="skill"><img src={`${process.env.PUBLIC_URL}/images/nextjs.png`} alt="Next Logo" className="logo"/><p>NextJS</p></div>
            <div className="skill"><img src={`${process.env.PUBLIC_URL}/images/reactq.png`} alt="React Query" className="logo"/><p>React Query</p></div>
            <div className="skill"><img src={`${process.env.PUBLIC_URL}/images/router.png`} alt="React Router" className="logo"/><p>React Router</p></div>
